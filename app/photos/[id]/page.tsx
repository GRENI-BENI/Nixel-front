        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="relative">
              ...
              {showCopied && (
                <div className={`absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1 bg-gray-800 text-white text-sm rounded-lg whitespace-nowrap ${isLabelFading ? 'animate-fade-out' : 'animate-fade-up'}`}>
                  Link copied!
                </div>
              )}
            </div>
